...
minetest.register_on_punchnode(function(pos, oldnode, digger)
	if oldnode.name == "ddecor:rope" then
		rope.remove(pos, oldnode, digger, "ddecor:rope")
	end
end)
...
ddecor.register("rope", {
	description = "Rope",
	drawtype = "plantlike",
	walkable = false,
	climbable = true,
	groups = {dig_immediate=3, flammable=3},
	tiles = {"ddecor_rope.png"},
	inventory_image = "ddecor_rope_inv.png",
	wield_image = "ddecor_rope_inv.png",
	selection_box = {
		type = "fixed",
