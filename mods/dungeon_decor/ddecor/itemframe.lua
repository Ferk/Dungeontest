...
minetest.register_entity("ddecor:f_item", {
	hp_max = 1,
	visual = "wielditem",
...
local remove_item = function(pos, node)
	...
	for _, obj in pairs(objs) do
		if obj and obj:get_luaentity() and
			obj:get_luaentity().name == "ddecor:f_item" then
			obj:remove()
		end
	end
end
...
local update_item = function(pos, node)
	...
	local e = minetest.add_entity(pos, "ddecor:f_item")
...
ddecor.register("frame", {
	...
	tiles = {
		"ddecor_wood.png", "ddecor_wood.png", "ddecor_wood.png",
		"ddecor_wood.png", "ddecor_wood.png", "ddecor_frame.png"
	},
	inventory_image = "ddecor_frame.png",
...
minetest.register_abm({
	nodenames = {"ddecor:frame"},
	interval = 15, chance = 1,
	action = function(pos, node, _, _)
		local num
		if node.name ~= "ddecor:frame" then return end
